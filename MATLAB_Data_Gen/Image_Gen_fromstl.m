%Generating all lighting conditions based on provided .stl files
...
% l = length(-3:0.5:3);
% L = [1*ones(l, 1), (-3:0.5:3)', -3*ones(l, 1);
%      1*ones(l, 1), (-3:0.5:3)', -2.5*ones(l, 1);
%      1*ones(l, 1), (-3:0.5:3)', -2*ones(l, 1);
%      1*ones(l, 1), (-3:0.5:3)', -1.5*ones(l, 1);
%      1*ones(l, 1), (-3:0.5:3)', -1*ones(l, 1);
%      1*ones(l, 1), (-3:0.5:3)', -0.5*ones(l, 1);
%      1*ones(l, 1), (-3:0.5:3)',  0*ones(l, 1);
%      1*ones(l, 1), (-3:0.5:3)',  0.5*ones(l, 1);
%      1*ones(l, 1), (-3:0.5:3)',  1*ones(l, 1);
%      1*ones(l, 1), (-3:0.5:3)',  1.5*ones(l, 1);
%      1*ones(l, 1), (-3:0.5:3)',  2*ones(l, 1);
%      1*ones(l, 1), (-3:0.5:3)',  2.5*ones(l, 1);
%      1*ones(l, 1), (-3:0.5:3)',  3*ones(l, 1)];
